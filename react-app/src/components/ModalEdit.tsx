        ...
        <div>
            {isModalOpen && (
                <div
                    ...
                    tabIndex={-1}
                    aria-hidden="true"
                    className="fixed top-0 right-0 left-0 z-50 h-screen bg-gray-500 bg-opacity-75 flex items-center justify-center"
                >
                                ...
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <textarea
                                            ...
                                            value="Descripiton bref de genie info"
                                        ></textarea>
                                    </div>
                                </div>
                                <button
